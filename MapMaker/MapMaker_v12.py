...
def afficher_decors(nbr_car, long_car, larg_car, coos=(0,0)):
    """Affiche les décors."""
    
    for x in range(coos[0],coos[0]+nbr_car):
        for y in range(coos[1],coos[1]+nbr_car):
            if grille_dec[x][y] != None and grille_dec[x][y] != 'vu':
                fltk.image((y-coos[1]+grille_dec[x][y][0][0]) * larg_car, (x-coos[0]+grille_dec[x][y][0][1]) * long_car, grille_dec[x][y][1], int(long_car/grille_dec[x][y][2]), int(larg_car/grille_dec[x][y][2]), ancrage=grille_dec[x][y][3], tag='image' + str(y) + str(x))
            ...
            if grille_dec[x][y]==None:
                ...
                if b in [x for x in range(5)]:
                    ...
                    if list_image [x][y][3] == 'H' and list_image[x][y][2] == 'P'and list_image[x][y][1] == 'H':
                        ...
                        #fltk.image((y+0.25)*largeur_carreau,(x+0.5)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/2), int(largeur_carreau/2), ancrage = 'nw', tag = 'siren'+str(x)+str(y))
                    
                    if list_image [x][y][0] == 'G' and list_image[x][y][1] == 'P'and list_image[x][y][2] == 'G':
                        zzzz = random.choice(decors)
                        grille_dec[x][y] = [(0.5,0.25),"decors/terre/"+zzzz,2,'nw']
                        #fltk.image((y+0.5)*largeur_carreau,(x+0.25)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/2), int(largeur_carreau/2), ancrage = 'nw', tag = 'siren'+str(x)+str(y))
                    
                    if list_image [x][y][3] == 'B' and list_image[x][y][0] == 'P'and list_image[x][y][1] == 'B':
                        zzzz = random.choice(decors)
                        grille_dec[x][y] = [(0.25,0),"decors/terre/"+zzzz,2,'nw']
                        #fltk.image((y+0.25)*largeur_carreau,(x)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/2), int(largeur_carreau/2), ancrage = 'nw', tag = 'siren'+str(x)+str(y))
                    
                    if list_image [x][y][0] == 'D' and list_image[x][y][3] == 'P'and list_image[x][y][2] == 'D':
                        zzzz = random.choice(decors)
                        grille_dec[x][y] = [(0,0.5),"decors/terre/"+zzzz,2,'nw']
                        #fltk.image((y)*largeur_carreau,(x+0.25)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/2), int(largeur_carreau/2), ancrage = 'nw', tag = 'siren'+str(x)+str(y))
                    ...
                    if list_image [x][y]=='GBSS':
                        ...
                        #fltk.image((y+0.5)*largeur_carreau,(x+0.6)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/2.5), int(largeur_carreau/2.5), ancrage = 'sw', tag = 'siren'+str(x)+str(y))
            
                    if list_image [x][y]=='SHGS':
                        zzzz = random.choice(decors)
                        grille_dec[x][y] = [(0.5,0.4),"decors/terre/"+zzzz,2.5,'nw']
                        #fltk.image((y+0.5)*largeur_carreau,(x+0.4)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/2.5), int(largeur_carreau/2.5), ancrage = 'nw', tag = 'siren'+str(x)+str(y))
            
                    if list_image [x][y]=='SSDH':
                        zzzz = random.choice(decors)
                        grille_dec[x][y] = [(0.5,0.4),"decors/terre/"+zzzz,2.5,'ne']
                        #fltk.image((y+0.5)*largeur_carreau,(x+0.4)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/2.5), int(largeur_carreau/2.5), ancrage = 'ne', tag = 'siren'+str(x)+str(y))
            
                    if list_image [x][y]=='DSSB':
                        zzzz = random.choice(decors)
                        grille_dec[x][y] = [(0.5,0.6),"decors/terre/"+zzzz,2.5,'se']
                        #fltk.image((y+0.5)*largeur_carreau,(x+0.6)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/2.5), int(largeur_carreau/2.5), ancrage = 'se', tag = 'siren'+str(x)+str(y))
                ...
                if x > len(list_image)-1 and y > len(list_image)-1:
                    if b in [6,7,8]:
                        ...
                        if un and deux and trois and quatre :
                            zzzz=random.choice(decors)
                            #fltk.image((y+0.85)*largeur_carreau,(x+0.85)*hauteur_carreau,"decors/terre/"+zzzz, int(hauteur_carreau/3), int(largeur_carreau/3), ancrage = 'nw', tag = 'siren'+str(x)+str(y))
